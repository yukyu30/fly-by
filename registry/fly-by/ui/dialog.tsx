 ...
 * fly-by Dialog
 *
 * クラス構造: dialog, fb-dialog-content, fb-dialog-header, etc.
 *
 * @example
 * <Dialog>
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "dialog-content fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg border border-gray-200 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] dark:border-gray-700 dark:bg-gray-900",
          className
        )}
        {...props}
      >
...
function DialogHeader({
  ...
  return (
    <div
      ...
      className={cn("dialog-header flex flex-col space-y-1.5 text-center sm:text-left", className)}
      {...props}
    />
  )
}
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("dialog-title text-lg font-semibold leading-none tracking-tight text-gray-900 dark:text-gray-100", className)}
      {...props}
    />
  )
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("dialog-description text-sm text-gray-600 dark:text-gray-400", className)}
      {...props}
    />
  )
}
