 ...
 * fly-by Alert
 *
 * クラス構造: alert, fb-alert-title, fb-alert-description
 *
 * @example
...
const alertVariants = cva(
  "alert relative w-full rounded-lg border p-4 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-current [&>svg~*]:pl-7",
  {
    variants: {
      color: {
        neutral:
