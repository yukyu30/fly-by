 ...
 * fly-by Textarea
 *
 * クラス構造: textarea -appearance-{outlined|filled} -size-{s|m|l}
 */

const textareaVariants = cva(
  "textarea flex w-full rounded-md transition-all outline-none disabled:cursor-not-allowed disabled:opacity-50 resize-y min-h-[80px]",
  {
    variants: {
      appearance: {
...
function Textarea({ className, appearance, size, ...props }: TextareaProps) {
  return (
    <textarea
      data-slot="textarea"
