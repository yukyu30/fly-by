 ...
 * fly-by Tabs
 *
 * クラス構造: tabs, fb-tabs-list -appearance-{value}, fb-tabs-trigger, fb-tabs-content
 *
 * @example
...
const fbTabsListVariants = cva(
  "tabs-list inline-flex items-center justify-center",
  {
    variants: {
      appearance: {
...
const fbTabsTriggerVariants = cva(
  "tabs-trigger inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      appearance: {
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "tabs-content mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
        className
      )}
      {...props}
    />
...
export { Tabs, TabsList, TabsTrigger, TabsContent, fbTabsListVariants, fbTabsTriggerVariants }
