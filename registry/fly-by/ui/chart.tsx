 ...
 *
 * クラス構造: chart-container, fb-chart-tooltip, fb-chart-legend
 *
 * @example
 * const chartConfig = {
 *   desktop: {
...
function ChartTooltipContent({
  ...
  return (
    <div
      ...
      className={cn(
        "chart-tooltip grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs shadow-xl dark:border-gray-700 dark:bg-gray-900",
        className
      )}
    >
...
function ChartLegendContent({
  ...
  return (
    <div
      ...
      className={cn(
        "chart-legend flex items-center justify-center gap-4",
