...
import { Sheet, SheetContent } from "@/registry/fly-by/ui/fb-sheet"
import { Separator } from "@/registry/fly-by/ui/fb-separator"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
 ...
 * 折りたたみ、レスポンシブ対応。
 *
 * クラス構造: sidebar, fb-sidebar-header, fb-sidebar-content, fb-sidebar-footer,
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "sidebar flex h-full w-[--sidebar-width] flex-col bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100",
          className
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        data-slot="sidebar"
        className={cn(
          "sidebar duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
          side === "left"
...
function SidebarRail({
  ...
  return (
    <button
      ...
      className={cn(
        "sidebar-rail absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-gray-200 dark:hover:after:bg-gray-700 group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
function SidebarInset({
  ...
  return (
    <main
      ...
      className={cn(
        "sidebar-inset relative flex min-h-svh flex-1 flex-col bg-white dark:bg-gray-950",
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn("sidebar-separator mx-2 w-auto bg-gray-200 dark:bg-gray-700", className)}
      {...props}
    />
  )
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "sidebar-group-label duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-gray-500 outline-none ring-gray-400 transition-[margin,opa] ease-linear focus-visible:ring-2 dark:text-gray-400 dark:ring-gray-500 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "sidebar-group-action absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-gray-500 outline-none ring-gray-400 transition-transform hover:bg-gray-100 hover:text-gray-900 focus-visible:ring-2 dark:text-gray-400 dark:ring-gray-500 dark:hover:bg-gray-800 dark:hover:text-gray-100 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuItem({
  ...
  return (
    <li
      ...
      className={cn("sidebar-menu-item group/menu-item relative", className)}
      {...props}
    />
  )
}
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "sidebar-menu-action absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-gray-500 outline-none ring-gray-400 transition-transform hover:bg-gray-100 hover:text-gray-900 focus-visible:ring-2 peer-hover/menu-button:text-gray-900 dark:text-gray-400 dark:ring-gray-500 dark:hover:bg-gray-800 dark:hover:text-gray-100 dark:peer-hover/menu-button:text-gray-100 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 after:md:hidden",
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "sidebar-menu-badge absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-gray-500 select-none pointer-events-none dark:text-gray-400",
...
function SidebarMenuSub({
  ...
  return (
    <ul
      ...
      className={cn(
        "sidebar-menu-sub mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-gray-200 px-2.5 py-0.5 dark:border-gray-700",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
